...
const upload = multer({
    ...
    fileFilter: (req, file, cb) => {
      // Allow common + quirky labels
      const ok = /(audio\/(x-m4a|m4a|mp4|aac|mpeg|mp3|wav|x-wav|ogg|flac|webm|3gpp|3gpp2))/.test(file.mimetype)
...
app.post('/clone', (req, res, next) => {
    ...
    try {
        ...
        fd.append('name', name);
        // ElevenLabs IVC accepts multiple files[]; add one or more
